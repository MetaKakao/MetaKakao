...
//    private final CustomOAuth2UserService customOAuth2UserService;
    ...
    public ResponseEntity<MsgEntity> callback(HttpServletRequest request) throws Exception {
        ...
        KakaoDTO kakaoInfo = kakaoService.getKakaoInfo(request.getParameter("code"), request);
        //kakaoDTO 객체 하나 만들어주고, KakaoService의 getKakaoInfo함수 실행, parameter는 auth코드.
//        String email = kakaoInfo.getEmail();
//        Map<String, Object> params = new HashMap<String, Object>();
//        params.put("id", kakaoInfo.getId());
//        params.put("email", kakaoInfo.getEmail());
//        params.put("nickname", kakaoInfo.getNickname());
//        customOAuth2UserService.generateDTO(email, params);
